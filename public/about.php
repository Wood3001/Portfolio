                    ...
                    <section class="about__sec-1 anchor">
                        ...
                        <div class="about__bio scroll-box__container blur flex">
                            <div class="scroll-box">
                                <p>My name is Richard <span class="highlight-txt">Sherwood</span> Seabrook. I have recently earned my "New Media Design & Web Development" Diploma from the British Columbia Institute of Technology. My educational journey has ignited a deep passion for crafting captivating user experiences. I specialize in transforming design concepts into seamlessly functioning interfaces, leveraging my proficiency in a diverse range of modern web technologies such as HTML5, CSS3, JavaScript, and responsive design principles. With an unwavering commitment to detail, strong problem-solving skills, and a dedication to staying current with industry trends, I consistently deliver digital solutions that balance aesthetics with functionality.</p>
